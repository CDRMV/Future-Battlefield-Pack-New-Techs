...
THeavyMaserCannonProjectile01 = import('/mods/Future Battlefield Pack New Techs/lua/FBPNTprojectiles.lua').THeavyMaserCannonProjectile

TDFMaserHeavy01 = Class(THeavyMaserCannonProjectile01) {
}
