...
UES0012b = Class(TConstructionUnit, CSeaUnit) {
	...
	OnStopBeingBuilt = function(self,builder,layer)
		...
		self.Station01 = CreateUnitHPR('uel0101', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station01:AttachBoneTo(0, self, 'Attachpoint01')
		self.Station02 = CreateUnitHPR('uel0103', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
		self.Station02:AttachBoneTo(0, self, 'Attachpoint02')
		self.Station03 = CreateUnitHPR('uel0104', self:GetArmy(), position.x, position.y, position.z, 0, 0, 0)
