...
local LightPhasonLaserCollisionBeam = CollisionBeamFile.LightPhasonLaserCollisionBeam
...
ADFLightPhasonLaser = Class(DefaultBeamWeapon) {
    BeamType = CollisionBeamFile.LightPhasonLaserCollisionBeam,
    FxMuzzleFlash = {},
    FxChargeMuzzleFlash = {},
    FxUpackingChargeEffects = EffectTemplate.CMicrowaveLaserCharge01,
    FxUpackingChargeEffectScale = 1,
